...
{
	(void)argc;	(void)argv;
	//test_ft_memset();	ft_putstr("\n");
	//test_ft_bzero(); 	ft_putstr("\n");
	//test_ft_memcpy();	ft_putstr("\n");
	//test_ft_memccpy();	ft_putstr("\n");
	//test_ft_memmove();	ft_putstr("\n");
	//test_ft_memcmp();	ft_putstr("\n");
	//test_ft_strlen();	ft_putstr("\n");
	//test_ft_strdup(); 	ft_putstr("\n");
	//test_ft_strcpy(); 	ft_putstr("\n");
	//test_ft_strncpy(); 	ft_putstr("\n");
	//test_ft_strcat(); 	ft_putstr("\n");
	//test_ft_strncat(); 	ft_putstr("\n");
	//test_ft_strlcat(); 	ft_putstr("\n");
	//test_ft_strchr(); 	ft_putstr("\n");
	//test_ft_strrchr(); 	ft_putstr("\n");
	//test_ft_strstr(); 	ft_putstr("\n");
	//test_ft_strnstr(); 	ft_putstr("\n");
	//test_ft_strcmp(); 	ft_putstr("\n");
	//test_ft_strncmp(); 	ft_putstr("\n");
	//test_ft_atoi();	ft_putstr("\n");
	//test_ft_isalpha();	ft_putstr("\n");
	//test_ft_isdigit();	ft_putstr("\n");
	//test_ft_isalnum();	ft_putstr("\n");
	//test_ft_isascii();	ft_putstr("\n");
	//test_ft_isprint();	ft_putstr("\n");
	//test_ft_toupper(); 	ft_putstr("\n");
	//test_ft_tolower(); 	ft_putstr("\n");
	
	//test_ft_strtrim(); 	ft_putstr("\n");
	//test_ft_strsplit(argc, argv); ft_putstr("\n");
	//test_ft_itoa(); 	ft_putstr("\n");
	//test_ft_putnbr(); 	ft_putstr("\n");

	//test_ft_swap(); 	ft_putstr("\n");
